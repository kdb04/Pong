...
fn main(){
    ...
    while !rl.window_should_close(){
        ...
        paddle1.update(SCREEN_HEIGHT, rl_ref.is_key_down(KeyboardKey::KEY_W), rl_ref.is_key_down(KeyboardKey::KEY_S));
        paddle2.update(SCREEN_HEIGHT, rl_ref.is_key_down(KeyboardKey::KEY_UP), rl_ref.is_key_down(KeyboardKey::KEY_DOWN));
